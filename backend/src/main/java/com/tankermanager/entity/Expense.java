...
@Entity
@Table(name = "tanker_expenses", indexes = {
        @Index(name = "idx_tanker_expenses_operator", columnList = "operator_id"),
        @Index(name = "idx_tanker_expenses_tanker", columnList = "tanker_id")
})
@Getter
@Setter
@NoArgsConstructor
